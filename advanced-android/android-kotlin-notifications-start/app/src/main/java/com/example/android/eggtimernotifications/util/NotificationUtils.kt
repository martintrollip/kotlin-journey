...
fun NotificationManager.sendNotification(messageBody: String, applicationContext: Context) {
    ...
    //A PendingIntent can be used by the OS or another app, it's simply a reference to a token maintained by the system
...
fun NotificationManager.cancelNotifications() {
    // You can set Notification Builder to only show the particular type once. You can also use the
    // notificationId to cancel particular notifications
    cancelAll()
}