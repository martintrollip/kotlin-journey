...
class AppNavigationTest {
    ...
    fun taskDetailScreen_doubleUpButton() = runBlocking {
        ...
        onView(withId(R.id.task_detail_title_text)).check(matches(ViewMatchers.withText("Up button")))
        onView(withId(R.id.task_detail_description_text)).check(matches(ViewMatchers.withText("Description")))
        onView(withId(R.id.task_detail_complete_checkbox)).check(matches(IsNot.not(ViewMatchers.isChecked())))
    ...
    fun taskDetailScreen_doubleBackButton() = runBlocking {
        ...
        onView(withId(R.id.task_detail_title_text)).check(matches(ViewMatchers.withText("Back button")))
        onView(withId(R.id.task_detail_description_text)).check(matches(ViewMatchers.withText("Description")))
        onView(withId(R.id.task_detail_complete_checkbox)).check(matches(IsNot.not(ViewMatchers.isChecked())))
...
Copy the getToolbarNavigationContentDescription extension function and add it to the end of AppNavigationTest.kt (outside of the class):
*/
