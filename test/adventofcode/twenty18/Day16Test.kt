...
class Day16Test {
    ...
    fun testAddr() {
        ...
        Addr().operation(a, b, c, before!!)

        assertTrue("Expected register C to have answer", before[c].value == 3)
        assertTrue("Expected register 0 to remain unchanged", before[0].value == 3)
        assertTrue("Expected register 1 to remain unchanged", before[1].value == 2)
        assertTrue("Expected register 3 to remain unchanged", before[3].value == 1)
    }
    ...
    fun testAddi() {
        ...
        Addi().operation(a, b, c, before!!)

        assertTrue("Expected register C to have answer", before[c].value == 2)
        assertTrue("Expected register 0 to remain unchanged", before[0].value == 3)
        assertTrue("Expected register 1 to remain unchanged", before[1].value == 2)
        assertTrue("Expected register 3 to remain unchanged", before[3].value == 1)
    }
    ...
    fun testMuli() {
        ...
        Muli().operation(a, b, c, before!!)

        assertTrue("Expected register C to have answer", before[c].value == 1)
        assertTrue("Expected register 0 to remain unchanged", before[0].value == 3)
        assertTrue("Expected register 1 to remain unchanged", before[1].value == 2)
        assertTrue("Expected register 3 to remain unchanged", before[3].value == 1)
    }
    ...
    fun testBanr() {
        ...
        assertTrue("Expected register C to have answer", before[c].value == 0)
        assertTrue("Expected register 0 to remain unchanged", before[0].value == 3)
        assertTrue("Expected register 1 to remain unchanged", before[1].value == 2)
        assertTrue("Expected register 3 to remain unchanged", before[3].value == 1)
        ...
        assertTrue("Expected register C to have answer", before[c].value == 4)
    }
    ...
    fun testBorr() {
        ...
        assertTrue("Expected register C to have answer", before[c].value == 5)
    }
    ...
    fun TestSetr() {
        ...
        assertTrue("Expected register C to have answer", before[c].value == 3)
        assertTrue("Expected register 0 to remain unchanged", before[0].value == 3)
        assertTrue("Expected register 1 to remain unchanged", before[1].value == 3232)
        assertTrue("Expected register 3 to remain unchanged", before[3].value == 1)
    }
